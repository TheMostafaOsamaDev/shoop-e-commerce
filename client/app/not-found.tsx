...
export default function NotFound() {
  return (
    <div className="sub-container grid grid-cols-1 lg:grid-cols-2 gap-4 items-center justify-between h-[calc(100vh-80px)]">
      <SvgComponent />
...
const SvgComponent = () => {
  return (
    <svg
      ...
      className="w-[650px] hidden lg:block"
    >
      <g>
        <defs>
        ...
        <g id="stars">
          ...
          <g id="circlesSmall">
            <circle cx="549.879" cy="296.402" fill="#0E0620" r="2.651" />
            <circle cx="253.29" cy="229.24" fill="#0E0620" r="2.651" />
            <circle cx="434.824" cy="263.931" fill="#0E0620" r="2.651" />
            <circle cx="183.708" cy="544.176" fill="#0E0620" r="2.651" />
            <circle cx="382.515" cy="530.923" fill="#0E0620" r="2.651" />
            <circle cx="130.693" cy="305.608" fill="#0E0620" r="2.651" />
            <circle cx="480.296" cy="477.014" fill="#0E0620" r="2.651" />
          </g>
        </g>
        <g clipPath="url(cordClip)" id="spaceman">
          <path
